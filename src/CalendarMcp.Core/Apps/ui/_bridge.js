 ...
 *
 * Shared verbatim with chetto1983/whatsapp-mcp's `ui/_bridge.js`. It is
 * server-agnostic by construction -- it speaks the ext-apps transport and knows
 * nothing about calendars -- so the two forks carry one implementation rather
 * than two that drift. Fix a transport bug in both.
 *
